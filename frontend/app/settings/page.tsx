        ...
        {tab === 'staff' && (
          <div className="space-y-4">
            <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 text-sm">
              ...
              <p className="text-xs text-orange-600 leading-relaxed">Cipta akaun staff di bawah. Setiap staff mendapat pautan QR unik. Kongsi pautan itu kepada staff â€” mereka boleh log masuk terus. Staff hanya boleh akses POS dan Queue sahaja.</p>
            </div>
